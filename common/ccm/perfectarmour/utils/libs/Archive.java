...
public final class Archive
{
    ...
    public static final String NBT_ARMOUR_TYPE_NAME_DISPLAY = NBT_ARMOUR_TYPE_NAME + ".TEXTURE";
    ...
    public static final String NBT_ARMOUR_PIECE_NAME_DISPLAY = NBT_ARMOUR_PIECE + ".NAME";
